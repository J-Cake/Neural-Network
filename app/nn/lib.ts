...
export type activation = { f: (x: number) => number, fPrime: (x: number) => number };
...
export default class Network {
    ...
    constructor(sizes: number[], activationFunctions: activation[], learningRate: number = 0.3, trainingSubset: number = 0, seed?: string) {
...
export class Layer {
    ...
    constructor(inputNeurons: number, outputNeurons: number, activationFunction: activation, prng: sr.prng, prevLayer?: Layer, layerIndex: number = 0) {
        if (layerIndex !== 0) {
